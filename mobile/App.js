  ...
  return (
    <ImageBackground
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.text}>AFD Detector - Get Disease Predictions</Text>
          ...
          <ImageBackground
            ...
            <View style={styles.result}>
              ...
              <Text style={styles.result_text}>
                ...
                quia dolore facilis! Earum ad quasi similique accusamus!
                Dignissimos, autem perspiciatis! Earum ad quasi similique
